...
const validSections = new Set(['overview', 'cases', 'appeals', 'staff-access', 'commands', 'logging', 'member-messages', 'roles', 'community', 'automod', 'anti-raid', 'anti-nuke', 'verification', 'billing', 'data']);

          ...
          <div className="dashboard-content">
            ...
            {activeSection === 'logging' && (
              <SettingsSection id="logging" title="Logging" description="Send each type of server activity to the right staff channel." guildId={guildId} csrf={session.csrf} section="general" data={drafts.general}>
                ...
                <div className="log-coverage-grid"><div><strong>Moderation</strong><span>Warnings, bans, kicks, timeouts and case actions.</span></div><div><strong>Security</strong><span>AutoMod actions, raid triggers and anti-nuke events.</span></div><div><strong>Messages</strong><span>Deleted, edited and bulk-deleted messages.</span></div><div><strong>Members</strong><span>Joins, leaves, role changes and nickname updates.</span></div><div><strong>Server</strong><span>Channel and role creation, deletion and changes.</span></div><div><strong>Appeals</strong><span>New submissions and moderation decisions.</span></div></div>
                <div className="form-grid">
